 ...
 */
public class mSimpleAdapter extends BaseAdapter implements Filterable {
    private int[] mTo;
    ...
    private boolean bindView(int position, View view, View emptyV) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            final View ev = emptyV.findViewById(to[i]);
            if (v != null) {
                ...
                if (!bound) {
                    if (v instanceof Checkable) {
                        if (data instanceof Boolean) {
                            ...
                            ((Checkable) ev).setChecked((Boolean) data);
                        ...
                        if (data instanceof Integer) {
                            ...
                            setViewImage((ImageView) ev, (Integer) data);
                        } else {
     ...
     *
     * @see #setViewBinder(com.miaomoe.www.miaomoe.mSimpleAdapter.ViewBinder)
     */
     ...
     *
     * @see mSimpleAdapter#setViewImage(ImageView, int)
     * @see mSimpleAdapter#setViewImage(ImageView, String)
     * @see mSimpleAdapter#setViewText(TextView, String)
     */
